  ...
  return (
    <div className="relative bg-black text-white overflow-hidden bg-grid-pattern min-h-screen">
      ...
      <section className="relative pt-28 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto z-10 text-center">
        ...
        {/* Animated Glow Pill */}
        <span className="inline-flex items-center space-x-2 bg-white/5 border border-white/10 px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider text-brand-purple mb-8 shadow-md shadow-brand-purple/5">
