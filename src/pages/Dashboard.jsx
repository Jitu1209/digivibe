          ...
          <div className="border-b border-white/5 pb-6 mb-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <span className="text-[10px] text-gray-500 font-mono mt-1 block">ID: {user.studentId}</span>
              </div>
            </div>
          </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                  ...
                  <div className="lg:col-span-2 space-y-4">
                    ...
                    <div className="glass-panel p-6 rounded-2xl border border-white/5 space-y-4">
                      ...
                      <div className="pt-2 border-t border-white/5 flex items-center justify-between text-xs">
                        ...
                        <button onClick={() => activeVideo && handleToggleLecture(activeVideo.id)} className="bg-white/5 border border-white/10 hover:bg-white/10 text-white font-bold px-4 py-2 rounded-lg text-[10px] uppercase">
                  ...
                  <div className="glass-panel p-6 rounded-2xl border border-white/10 space-y-6">
                    ...
                    {lectures.every(l => l.comp) ? (
                      ...
                      <button disabled className="w-full bg-white/5 border border-white/5 text-gray-500 font-bold py-3.5 rounded-xl text-xs uppercase cursor-not-allowed">
                        Syllabus Incomplete
                      </button>
                    )}
                  </div>
