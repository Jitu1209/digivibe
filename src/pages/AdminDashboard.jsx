      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 relative">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between border-b border-white/10 pb-6 mb-10 gap-4">
          ...
          <div className="flex space-x-2">
            <button onClick={() => setActiveSubTab('analytics')} className={`px-4 py-2 rounded-lg font-bold text-xs uppercase tracking-wider transition-all ${activeSubTab === 'analytics' ? 'bg-brand-cyan text-black' : 'bg-white/5 border border-white/10 text-gray-300 hover:text-white'}`}>
              Analytics Report
            </button>
            <button onClick={() => setActiveSubTab('leads')} className={`px-4 py-2 rounded-lg font-bold text-xs uppercase tracking-wider transition-all ${activeSubTab === 'leads' ? 'bg-brand-cyan text-black' : 'bg-white/5 border border-white/10 text-gray-300 hover:text-white'}`}>
                  ...
                  <div key={idx} className="glass-panel p-6 rounded-xl border border-white/10 relative space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-2 text-[10px] text-gray-500 font-mono">
                        ...
                        <button onClick={() => handleDeleteLead(idx)} className="text-gray-500 hover:text-brand-blue p-1 rounded focus:outline-none transition-colors" title="Delete Inquiry">
