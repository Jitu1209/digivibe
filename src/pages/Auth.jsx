          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input type="email" required value={loginForm.email} onChange={(e) => setLoginForm({...loginForm, email: e.target.value})} className="w-full bg-white border border-white/10/80 shadow-sm border border-white/10 rounded-lg pl-10 pr-4 py-2.5 text-xs text-white focus:border-brand-purple outline-none" placeholder="student@beyondskills.in" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="password" required value={loginForm.password} onChange={(e) => setLoginForm({...loginForm, password: e.target.value})} className="w-full bg-white border border-white/10/80 shadow-sm border border-white/10 rounded-lg pl-10 pr-4 py-2.5 text-xs text-white focus:border-brand-purple outline-none" placeholder="password" />
              </div>
            </div>
          ...
          <form onSubmit={handleRegisterSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" required value={registerForm.name} onChange={(e) => setRegisterForm({...registerForm, name: e.target.value})} className="w-full bg-white border border-white/10/80 shadow-sm border border-white/10 rounded-lg pl-10 pr-4 py-2.5 text-xs text-white focus:border-brand-purple outline-none" placeholder="John Doe" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <Mail className="absolute left-3 top-3 w-4 h-4 text-gray-400" />
                <input type="email" required value={registerForm.email} onChange={(e) => setRegisterForm({...registerForm, email: e.target.value})} className="w-full bg-white border border-white/10/80 shadow-sm border border-white/10 rounded-lg pl-10 pr-4 py-2.5 text-xs text-white focus:border-brand-purple outline-none" placeholder="johndoe@gmail.com" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="tel" required value={registerForm.phone} onChange={(e) => setRegisterForm({...registerForm, phone: e.target.value})} className="w-full bg-white border border-white/10/80 shadow-sm border border-white/10 rounded-lg pl-10 pr-4 py-2.5 text-xs text-white focus:border-brand-purple outline-none" placeholder="9876543210" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <Lock className="absolute left-3 top-3 w-4 h-4 text-gray-400" />
                <input type="password" required value={registerForm.password} onChange={(e) => setRegisterForm({...registerForm, password: e.target.value})} className="w-full bg-white border border-white/10/80 shadow-sm border border-white/10 rounded-lg pl-10 pr-4 py-2.5 text-xs text-white focus:border-brand-purple outline-none" placeholder="Create Password" />
              </div>
            </div>
        ...
        {mode === 'otp' && (
          ...
          <form onSubmit={handleVerifyOtp} className="space-y-6">
            ...
            <div>
              ...
              <input type="text" maxLength={4} required value={otpVal} onChange={(e) => setOtpVal(e.target.value)} className="w-28 mx-auto block bg-white border border-white/10/80 shadow-sm border border-white/15 rounded-lg py-2.5 text-center font-mono font-bold text-lg text-white focus:border-brand-purple outline-none tracking-widest" placeholder="0000" />
            </div>
            ...
            <div className="flex space-x-3">
              <button type="button" onClick={() => setMode('register')} className="w-1/3 bg-brand-darker border border-white/10 hover:bg-white/10 text-white font-bold py-2.5 rounded-lg text-xs uppercase">
                Back
              </button>
        ...
        {mode === 'reset' && (
          ...
          <form onSubmit={handlePasswordReset} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <Mail className="absolute left-3 top-3 w-4 h-4 text-gray-400" />
                <input type="email" required value={resetEmail} onChange={(e) => setResetEmail(e.target.value)} className="w-full bg-white border border-white/10/80 shadow-sm border border-white/10 rounded-lg pl-10 pr-4 py-2.5 text-xs text-white focus:border-brand-purple outline-none" placeholder="enteremail@gmail.com" />
              </div>
            </div>

            <div className="flex space-x-3">
              <button type="button" onClick={() => setMode('login')} className="w-1/3 bg-brand-darker border border-white/10 hover:bg-white/10 text-white font-bold py-2.5 rounded-lg text-xs uppercase">
                Cancel
              </button>
