  ...
  return (
    <div className="text-white min-h-screen relative pt-12 pb-24 print:bg-white print:text-black">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 z-10 relative print:p-0">
        ...
        <div className="glass-panel p-8 rounded-2xl border border-white/10 space-y-6 print:hidden">
          
          <div className="border-b border-white/10/60 pb-6 grid grid-cols-2 gap-4">
            <div>
              <span className="text-[10px] text-gray-400 uppercase font-bold block">Assigned Student ID</span>
              <span className="text-lg font-bold text-brand-purple font-mono">{studentId || 'BS-2026-1004'}</span>
            </div>
            <div>
              <span className="text-[10px] text-gray-400 uppercase font-bold block">Course Allocated</span>
              <span className="text-sm font-bold text-white leading-tight block mt-1">{course.title}</span>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3.5 text-xs text-gray-300">
              <div className="flex items-start space-x-3 bg-brand-darker p-3 rounded-lg border border-white/10/60">
          ...
          {/* Actions */}
          <div className="border-t border-white/10/60 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            <button onClick={() => setInvoiceOpen(true)} className="w-full sm:w-auto bg-brand-darker hover:bg-white/10 border border-white/10 text-black font-bold px-6 py-3 rounded-xl text-xs uppercase tracking-wider flex items-center justify-center space-x-2">
              <FileText className="w-4.5 h-4.5 text-brand-purple" />
              <span>Generate PDF Invoice</span>
            </button>

            <button onClick={handleGoToDashboard} className="w-full sm:w-auto bg-gradient-to-r from-brand-purple to-brand-blue hover:brightness-110 text-black font-bold px-6 py-3 rounded-xl text-xs uppercase tracking-wider flex items-center justify-center space-x-2 shadow-lg shadow-brand-purple/15 hover:scale-105 transition-all">
            ...
            <div className="bg-white text-black rounded-xl max-w-2xl w-full p-8 shadow-2xl space-y-6 relative border border-gray-200 print:shadow-none print:border-0 print:p-0">
              ...
              <div className="border-b border-gray-200 pb-6 flex justify-between items-start">
                <div>
                  ...
                  <p className="text-xs text-gray-400 uppercase font-semibold mt-1">Upskilling Academy Division</p>
                </div>
              ...
              <div className="grid grid-cols-2 gap-6 text-xs border-b border-gray-100 pb-6">
                <div>
                  ...
                  <p className="text-gray-400">Sector 62, Electronic City, Noida</p>
                  <p className="text-gray-400">GSTIN: 09AAECD9832K1ZP</p>
                </div>
                <div>
                  ...
                  <p className="text-gray-400">Receipt Ref: {payId || 'pay_mock_12345'}</p>
                  <p className="text-gray-400">Registered Onboarding Address</p>
                </div>
              </div>
              ...
              <table className="w-full text-xs text-left">
                ...
                <tbody>
                  <tr className="border-b border-gray-100 text-gray-700">
                    ...
                    <td className="py-3 text-center text-gray-400">{course.duration}</td>
