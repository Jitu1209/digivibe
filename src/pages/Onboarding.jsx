  ...
  return (
    <div className="text-white min-h-screen relative pt-12 pb-24 print:bg-white print:text-black">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 z-10 relative print:p-0">
        ...
        {invoiceOpen && (
          <div className="fixed inset-0 z-50 overflow-y-auto bg-black/90 flex items-center justify-center p-4 print:relative print:bg-white print:text-black print:p-0">
              ...
              <table className="w-full text-xs text-left">
                ...
                <tbody>
                  <tr className="border-b border-gray-100 text-gray-700">
                    ...
                    <td className="py-3 text-center text-gray-500">{course.duration}</td>
