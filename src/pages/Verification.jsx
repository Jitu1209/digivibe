  ...
  if (dlParam && cert) {
    return (
      <div className="bg-[#111111] text-white min-h-screen flex flex-col items-center justify-center p-4 print:bg-white print:text-black print:p-0">
        ...
        {/* Certificate Frame */}
        <div className="max-w-4xl w-full bg-black border-[12px] border-brand-purple/20 rounded-2xl p-12 text-center relative overflow-hidden shadow-2xl print:border-brand-purple/40 print:shadow-none print:p-8 print:w-full print:bg-white print:text-black">
      ...
      <div className="glass-panel p-8 rounded-2xl border border-white/10 max-w-xl w-full z-10 space-y-8">
        ...
        <form onSubmit={handleFormSubmit} className="flex space-x-3">
          <div className="relative flex-1">
            ...
            <input type="text" required value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} className="w-full bg-black/40 border border-white/10 rounded-xl pl-10 pr-4 py-3 text-xs text-white focus:border-brand-purple outline-none" placeholder="Enter Certificate Reference ID..." />
          </div>
        ...
        {searched && (
          <div className="pt-6 border-t border-white/5">
            {cert ? (
              /* MATCH FOUND */
              <div className="bg-white/5 border border-brand-purple/30 rounded-2xl p-6 space-y-6">
