        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 items-start">
            ...
            <div className="glass-panel p-6 rounded-xl border border-white/5 space-y-6">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-1">connect@beyondskills.in</p>
                </div>
              </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="flex border-b border-white/10 space-x-6 pb-2">
              <button onClick={() => { setActiveForm('agency'); setStatus(null); }} className={`pb-4 font-bold text-sm uppercase tracking-wider transition-colors relative ${activeForm === 'agency' ? 'text-brand-purple' : 'text-gray-400 hover:text-white'}`}>
                <span>Agency Request</span>
                {activeForm === 'agency' && <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-brand-purple"></div>}
              </button>
              <button onClick={() => { setActiveForm('academy'); setStatus(null); }} className={`pb-4 font-bold text-sm uppercase tracking-wider transition-colors relative ${activeForm === 'academy' ? 'text-brand-purple' : 'text-gray-400 hover:text-white'}`}>
            ...
            <div className="glass-panel p-8 rounded-2xl border border-white/10">
              {status === 'agency_success' && (
                <div className="bg-brand-purple/15 border border-brand-purple/30 text-white p-4 rounded-xl mb-6 text-xs">
              ...
              {activeForm === 'agency' ? (
                ...
                <form onSubmit={handleAgencySubmit} className="space-y-6">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input type="text" required value={agencyForm.name} onChange={(e) => setAgencyForm({...agencyForm, name: e.target.value})} className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-sm focus:border-brand-purple focus:ring-1 focus:ring-brand-purple outline-none text-white transition-all" placeholder="John Doe" />
                    </div>
                    <div>
                      <label className="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Company Name *</label>
                      <input type="text" required value={agencyForm.company} onChange={(e) => setAgencyForm({...agencyForm, company: e.target.value})} className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-sm focus:border-brand-purple focus:ring-1 focus:ring-brand-purple outline-none text-white transition-all" placeholder="Tech Startup Inc." />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input type="email" required value={agencyForm.email} onChange={(e) => setAgencyForm({...agencyForm, email: e.target.value})} className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-sm focus:border-brand-purple focus:ring-1 focus:ring-brand-purple outline-none text-white transition-all" placeholder="john@company.com" />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <textarea rows={4} value={agencyForm.message} onChange={(e) => setAgencyForm({...agencyForm, message: e.target.value})} className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-sm focus:border-brand-purple focus:ring-1 focus:ring-brand-purple outline-none text-white transition-all" placeholder="Provide scope details, design criteria, or timelines..."></textarea>
                  </div>
                ...
                <form onSubmit={handleAcademySubmit} className="space-y-6">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                      <label className="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Name *</label>
                      <input type="text" required value={academyForm.name} onChange={(e) => setAcademyForm({...academyForm, name: e.target.value})} className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-sm focus:border-brand-purple focus:ring-1 focus:ring-brand-purple outline-none text-white transition-all" placeholder="John Doe" />
                    </div>
                    <div>
                      <label className="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Email Address *</label>
                      <input type="email" required value={academyForm.email} onChange={(e) => setAcademyForm({...academyForm, email: e.target.value})} className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-sm focus:border-brand-purple focus:ring-1 focus:ring-brand-purple outline-none text-white transition-all" placeholder="john@gmail.com" />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input type="text" required value={academyForm.college} onChange={(e) => setAcademyForm({...academyForm, college: e.target.value})} className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-sm focus:border-brand-purple focus:ring-1 focus:ring-brand-purple outline-none text-white transition-all" placeholder="BITS Pilani" />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <textarea rows={4} value={academyForm.message} onChange={(e) => setAcademyForm({...academyForm, message: e.target.value})} className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-sm focus:border-brand-purple focus:ring-1 focus:ring-brand-purple outline-none text-white transition-all" placeholder="Any doubts regarding live schedule, recorded classes, or dashboard tools..."></textarea>
                  </div>
